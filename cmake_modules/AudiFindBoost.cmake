...
find_package(Boost ${_AUDI_BOOST_MINIMUM_VERSION} REQUIRED COMPONENTS ${_AUDI_REQUIRED_BOOST_LIBS} CONFIG)
if(NOT Boost_FOUND)
...
foreach(_AUDI_BOOST_COMPONENT ${_AUDI_REQUIRED_BOOST_LIBS})
    if(NOT TARGET Boost::${_AUDI_BOOST_COMPONENT})
        message(STATUS "The 'Boost::${_AUDI_BOOST_COMPONENT}' imported target is missing, creating it.")
        string(TOUPPER ${_AUDI_BOOST_COMPONENT} _AUDI_BOOST_UPPER_COMPONENT)
        if(Boost_USE_STATIC_LIBS)
            add_library(Boost::${_AUDI_BOOST_COMPONENT} STATIC IMPORTED)
        else()
            add_library(Boost::${_AUDI_BOOST_COMPONENT} UNKNOWN IMPORTED)
        endif()
        set_target_properties(Boost::${_AUDI_BOOST_COMPONENT} PROPERTIES
